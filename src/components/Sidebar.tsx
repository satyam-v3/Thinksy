...
import { useAuth } from "../context/AuthContext"; // 👈 Imported the auth context
        ...
        <>
            ...
            >
                                ...
                                >
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <div className="text-[13px] truncate">
                                            {truncate(c.title || "Untitled", 38)}
                                        </div>
                                        <div className="text-[10px] text-muted">
                                            {formatDay(c.updatedAt)} · {c.messages.length} msg
                                        </div>
                                    </div>
                ...
                <div className="flex items-center justify-between border-t border-border px-3 py-3">
                    ...
                    {/* 👈 Added the Logout button next to the ThemeToggle */}
                    <div className="flex items-center gap-2">
                        <button
                            onClick={logout}
                            className="flex h-8 w-8 items-center justify-center rounded-md text-muted hover:bg-surface2 hover:text-red-500 transition-colors"
                            aria-label="Log out"
                            title="Log out"
                        >
